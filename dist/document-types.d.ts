 ...
 * https://spec.openapis.org/oas/v3.1.0#path-item-object
 */
export declare enum OAOperationMethod {
    GET = "get",
    PUT = "put",
    POST = "post",
    DELETE = "delete",
 ...
 */
export declare enum OAParameterLocation {
    QUERY = "query",
    HEADER = "header",
    PATH = "path",
    COOKIE = "cookie"
 ...
 */
export declare enum OADataType {
    STRING = "string",
    NUMBER = "number",
    BOOLEAN = "boolean",
    OBJECT = "object",
 ...
 */
export declare enum OADataFormat {
    INT32 = "int32",
    INT64 = "int64",
    FLOAT = "float",
    DOUBLE = "double",
...
export type OARequestBodyObject = {
    description?: string;
    content: {
        [mediaType: string]: OAMediaTypeObject;
    };
    required?: boolean;
};
/**
...
export type OAMediaTypeObject = {
    ...
    encoding?: {
        [name: string]: OAEncodingObject | undefined;
    };
};
/**
 * Example Object.
...
export type OAComponentsObject = {
    schemas?: {
        [name: string]: OASchemaObject | undefined;
    };
    responses?: {
 ...
 * https://spec.openapis.org/oas/v3.1.0#security-scheme-object
 */
export declare enum OASecuritySchemeType {
    API_KEY = "apiKey",
    HTTP = "http",
 ...
 * https://spec.openapis.org/oas/v3.1.0#security-scheme-object
 */
export declare enum OAApiKeyLocation {
    QUERY = "query",
    HEADER = "header",
    COOKIE = "cookie"
}
